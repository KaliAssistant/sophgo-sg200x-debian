$(BUILDDIR)/jack-coreutils-stamp:
	...
	@wget -O /output/lichee-jack-utils.tar.xz https://github.com/KaliAssistant/Lichee-Jack-utils/releases/download/2025.09-ac2a0da/lichee-jack-utils_2025-09-ac2a0da_all.tar.xz
