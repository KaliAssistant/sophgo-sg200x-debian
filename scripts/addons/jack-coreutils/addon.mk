$(BUILDDIR)/jack-coreutils-stamp:
	...
	@wget -O /output/lichee-jack-utils.tar.xz https://github.com/KaliAssistant/Lichee-Jack-utils/releases/download/2026.01-f889c27/lichee-jack-utils_2026.01-f889c27_all.tar.xz
